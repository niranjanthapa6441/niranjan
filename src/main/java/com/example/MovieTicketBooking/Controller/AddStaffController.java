...
public class AddStaffController {
    ...
    public AddStaffController(RegisterCustomerService registerCustomerService) {
    ...
    public String registerCustomer(Model model){
        ...
        model.addAttribute("userAdded",customer);
        return "Registration";
    }
    @PostMapping
    public String saveCustomer(@ModelAttribute Customer customer, Model model, RedirectAttributes redirectAttributes){
        if(customer.getPassword().equals(customer.getConfirmPassword())) {
            ...
            String encodedCPassword = encoder.encode(customer.getConfirmPassword());
